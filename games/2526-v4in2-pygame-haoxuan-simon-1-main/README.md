[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=23505765)
# PyGame opdracht
...
## Verplichte packets
In de terminal gebruik de command: pip install "placeholder".
In ons geval zijn er maar 2 verplichte packets nodig.
Namelijk lxml en beautifulsoup4 dus om de packets te downloaden voer je de commands:
    pip install lxml
    pip install beautifulsoup4
Of om het nog makkelijker te maken kan je ook de volgende command invoeren:
    python3 -m pip install -r requirements.txt

## Code uitvoeren
Start het programma:
- Type in de terminal `python main.py` en druk dan op de toets `[Enter↵]`
